...
final class MiniDAWController: NSViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let title = NSTextField(labelWithString: "MiniDAW – Funktionsnachweis"); title.font = .systemFont(ofSize: 24, weight: .bold)
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ n: Notification) {
        ...
        window.title = "MiniDAW Functional Test"; window.contentViewController = vc; window.center(); window.makeKeyAndOrderFront(nil); NSApp.activate(ignoringOtherApps: true)
    }
